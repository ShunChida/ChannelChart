@php    
    ...
    $its_channel_id = $video['snippet']['channelId'];
    $its_channel_icon = $channels[$its_channel_id]['snippet']['thumbnails']['default']['url'];
@endphp
<div class="content col-6 col-sm-4 col-md-3">
    <a href="http://www.youtube.com/watch?v={{ $video['id']['videoId'] }}" class="thumbnail" target="_blank">
        
        <div class="container" style="padding:1px;">
            <div class="row" style="width:100%;margin:0;">
                
                <div class="col-12 col-sm-12 col-md-12" style="padding:0 0 5px 0;text-align: center;">
                    <img class="rounded" src="{{ $video['snippet']['thumbnails']['medium']['url'] }}" style="box-shadow: 0 0 5px 5px black inset;">
                </div>
